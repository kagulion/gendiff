...
Вычислитель отличий — это консольная утилита и библиотека для сравнения файлов с данными в форматах JSON и YAML. Программа анализирует два файла и показывает различия между ними в удобном для восприятия виде.
